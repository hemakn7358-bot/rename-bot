...
async def donatecm(bot,message):
    ...
    keybord = InlineKeyboardMarkup([
        [InlineKeyboardButton("🦋 Admin",url = "@ATF_Admin_Gojo"),
...
async def home_callback_handler(bot, query):
    text = f"""Hello {query.from_user.mention} \n\n➻ This Is An Advanced And Yet Powerful Rename Bot.\n\n➻ Using This Bot You Can Rename And Change Thumbnail Of Your Files.\n\n➻ You Can Also Convert Video To File Aɴᴅ File To Video.\n\n➻ This Bot Also Supports Custom Thumbnail And Custom Caption.\n\n<b>Bot Is Made By @ATF_Admin_Gojo</b>"""
    keybord = InlineKeyboardMarkup([  
                    [InlineKeyboardButton("📢 Updates", url="@ATF_Admin_Gojo"),
                    InlineKeyboardButton("💬 Support", url="https://t.me/Anime_friend001")],
                    [InlineKeyboardButton("🛠️ Help", callback_data='help'),
		            InlineKeyboardButton("❤️‍🩹 About", callback_data='about')],
                    [InlineKeyboardButton("🧑‍💻 Developer 🧑‍💻", url="https://t.me/Anime_friend001")]
		  ])
